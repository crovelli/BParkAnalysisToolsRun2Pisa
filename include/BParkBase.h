...
// Tue Apr  4 12:13:19 2023 by ROOT version 6.24/08
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_bphys/crovelli/nanoaod_RK/BParkingNANO_2023Apr03/BuToKee_MufilterPt6Eta1p6_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/crab_BuToKee/230403_211851/0000/BParkNANO_mc_2023Apr03_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nBToKEE;
   Float_t         BToKEE_b_3diso03[4000];   //[nBToKEE]
   Float_t         BToKEE_b_3diso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_b_3diso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_b_3diso04[4000];   //[nBToKEE]
   Float_t         BToKEE_b_3diso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_b_3diso04_dca_tight[4000];   //[nBToKEE]
   ...
   Float_t         BToKEE_fit_cos3D[4000];   //[nBToKEE]
   ...
   Float_t         BToKEE_k_3diso03[4000];   //[nBToKEE]
   Float_t         BToKEE_k_3diso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_k_3diso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_k_3diso04[4000];   //[nBToKEE]
   Float_t         BToKEE_k_3diso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_k_3diso04_dca_tight[4000];   //[nBToKEE]
   ...
   Float_t         BToKEE_l1_3diso03[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_3diso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_3diso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_3diso04[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_3diso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l1_3diso04_dca_tight[4000];   //[nBToKEE]
   ...
   Float_t         BToKEE_l2_3diso03[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_3diso03_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_3diso03_dca_tight[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_3diso04[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_3diso04_dca[4000];   //[nBToKEE]
   Float_t         BToKEE_l2_3diso04_dca_tight[4000];   //[nBToKEE]
   ...
   Float_t         BToKEE_l_xy_pv[4000];   //[nBToKEE]
   Float_t         BToKEE_l_xy_unc[4000];   //[nBToKEE]
   Float_t         BToKEE_l_xy_unc_pv[4000];   //[nBToKEE]
   ...
   UInt_t          nBToKMuMu;
   Float_t         BToKMuMu_b_3diso03[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_3diso03_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_3diso03_dca_tight[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_3diso04[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_3diso04_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_b_3diso04_dca_tight[3500];   //[nBToKMuMu]
   ...
   Float_t         BToKMuMu_fit_cos3D[3500];   //[nBToKMuMu]
   ...
   Float_t         BToKMuMu_k_3diso03[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_3diso03_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_3diso03_dca_tight[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_3diso04[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_3diso04_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_k_3diso04_dca_tight[3500];   //[nBToKMuMu]
   ...
   Float_t         BToKMuMu_l1_3diso03[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_3diso03_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_3diso03_dca_tight[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_3diso04[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_3diso04_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l1_3diso04_dca_tight[3500];   //[nBToKMuMu]
   ...
   Float_t         BToKMuMu_l2_3diso03[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_3diso03_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_3diso03_dca_tight[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_3diso04[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_3diso04_dca[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l2_3diso04_dca_tight[3500];   //[nBToKMuMu]
   ...
   Float_t         BToKMuMu_l_xy_pv[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l_xy_unc[3500];   //[nBToKMuMu]
   Float_t         BToKMuMu_l_xy_unc_pv[3500];   //[nBToKMuMu]
   ...
   UInt_t          nBToKsEE;
   Float_t         BToKsEE_b_iso03[2000];   //[nBToKsEE]
   Float_t         BToKsEE_b_iso04[2000];   //[nBToKsEE]
   Float_t         BToKsEE_barMass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_chi2[2000];   //[nBToKsEE]
   Float_t         BToKsEE_cos2D[2000];   //[nBToKsEE]
   Float_t         BToKsEE_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_barKstar_mass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_barMass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_cos2D[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_mass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_kstar_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l1_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_l2_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_mass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_massErr[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk1_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_eta[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_fit_trk2_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l1_iso03[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l1_iso04[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l2_iso03[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l2_iso04[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l_xy[2000];   //[nBToKsEE]
   Float_t         BToKsEE_l_xy_unc[2000];   //[nBToKsEE]
   Float_t         BToKsEE_mass[2000];   //[nBToKsEE]
   Float_t         BToKsEE_max_dr[2000];   //[nBToKsEE]
   Float_t         BToKsEE_min_dr[2000];   //[nBToKsEE]
   Float_t         BToKsEE_mll_fullfit[2000];   //[nBToKsEE]
   Float_t         BToKsEE_mll_llfit[2000];   //[nBToKsEE]
   Float_t         BToKsEE_mll_raw[2000];   //[nBToKsEE]
   Float_t         BToKsEE_phi[2000];   //[nBToKsEE]
   Float_t         BToKsEE_pt[2000];   //[nBToKsEE]
   Float_t         BToKsEE_svprob[2000];   //[nBToKsEE]
   Float_t         BToKsEE_tk1_iso03[2000];   //[nBToKsEE]
   Float_t         BToKsEE_tk1_iso04[2000];   //[nBToKsEE]
   Float_t         BToKsEE_tk2_iso03[2000];   //[nBToKsEE]
   Float_t         BToKsEE_tk2_iso04[2000];   //[nBToKsEE]
   Int_t           BToKsEE_charge[2000];   //[nBToKsEE]
   Int_t           BToKsEE_kstar_idx[2000];   //[nBToKsEE]
   Int_t           BToKsEE_l1_idx[2000];   //[nBToKsEE]
   Int_t           BToKsEE_l2_idx[2000];   //[nBToKsEE]
   Int_t           BToKsEE_pdgId[2000];   //[nBToKsEE]
   Int_t           BToKsEE_trk1_idx[2000];   //[nBToKsEE]
   Int_t           BToKsEE_trk2_idx[2000];   //[nBToKsEE]
   UInt_t          nBToKsMuMu;
   Float_t         BToKsMuMu_b_iso03[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_b_iso04[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_barMass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_chi2[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_cos2D[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_barKstar_mass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_barMass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_cos2D[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_mass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_kstar_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l1_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_l2_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_mass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_massErr[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk1_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_eta[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_fit_trk2_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l1_iso03[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l1_iso04[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l2_iso03[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l2_iso04[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l_xy[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_l_xy_unc[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mass[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_max_dr[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_min_dr[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_fullfit[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_llfit[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_mll_raw[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_phi[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_pt[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_svprob[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk1_iso03[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk1_iso04[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk2_iso03[500];   //[nBToKsMuMu]
   Float_t         BToKsMuMu_tk2_iso04[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_charge[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_kstar_idx[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_l1_idx[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_l2_idx[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_pdgId[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_trk1_idx[500];   //[nBToKsMuMu]
   Int_t           BToKsMuMu_trk2_idx[500];   //[nBToKsMuMu]
   UInt_t          nKstar;
   ...
   UInt_t          nElectron;
   Float_t         Electron_convChi2Prob[400];   //[nElectron]
   Float_t         Electron_convDeltaCotFromPin[400];   //[nElectron]
   Float_t         Electron_convLxy[400];   //[nElectron]
   Float_t         Electron_convMass[400];   //[nElectron]
   Float_t         Electron_convMassAfterFit[400];   //[nElectron]
   Float_t         Electron_convMassBeforeFit[400];   //[nElectron]
   Float_t         Electron_convMassFromPin[400];   //[nElectron]
   Float_t         Electron_convMinTrkPt[400];   //[nElectron]
   Float_t         Electron_convVtxRadius[400];   //[nElectron]
   Float_t         Electron_dxy[400];   //[nElectron]
   Float_t         Electron_dxyErr[400];   //[nElectron]
   Float_t         Electron_dz[400];   //[nElectron]
   Float_t         Electron_dzErr[400];   //[nElectron]
   Float_t         Electron_dzTrg[400];   //[nElectron]
   Float_t         Electron_eta[400];   //[nElectron]
   Float_t         Electron_fBrem[400];   //[nElectron]
   Float_t         Electron_ip3d[400];   //[nElectron]
   Float_t         Electron_mass[400];   //[nElectron]
   Float_t         Electron_mvaId[400];   //[nElectron]
   Float_t         Electron_pfRelIso[400];   //[nElectron]
   Float_t         Electron_pfmvaId[400];   //[nElectron]
   Float_t         Electron_phi[400];   //[nElectron]
   Float_t         Electron_pt[400];   //[nElectron]
   Float_t         Electron_ptBiased[400];   //[nElectron]
   Float_t         Electron_sip3d[400];   //[nElectron]
   Float_t         Electron_trkRelIso[400];   //[nElectron]
   Float_t         Electron_unBiased[400];   //[nElectron]
   Float_t         Electron_vx[400];   //[nElectron]
   Float_t         Electron_vy[400];   //[nElectron]
   Float_t         Electron_vz[400];   //[nElectron]
   Int_t           Electron_charge[400];   //[nElectron]
   Int_t           Electron_convDeltaExpectedNHitsInner[400];   //[nElectron]
   Int_t           Electron_convLeadIdx[400];   //[nElectron]
   Int_t           Electron_convLeadNHitsBeforeVtx[400];   //[nElectron]
   Int_t           Electron_convMaxNHitsBeforeVtx[400];   //[nElectron]
   Int_t           Electron_convSumNHitsBeforeVtx[400];   //[nElectron]
   Int_t           Electron_convTracksN[400];   //[nElectron]
   Int_t           Electron_convTrailIdx[400];   //[nElectron]
   Int_t           Electron_convTrailNHitsBeforeVtx[400];   //[nElectron]
   Int_t           Electron_pdgId[400];   //[nElectron]
   Bool_t          Electron_convExtra[400];   //[nElectron]
   Bool_t          Electron_convLead[400];   //[nElectron]
   Bool_t          Electron_convLoose[400];   //[nElectron]
   Bool_t          Electron_convOpen[400];   //[nElectron]
   Bool_t          Electron_convQualityHighEff[400];   //[nElectron]
   Bool_t          Electron_convQualityHighPurity[400];   //[nElectron]
   Bool_t          Electron_convTight[400];   //[nElectron]
   Bool_t          Electron_convTrail[400];   //[nElectron]
   Bool_t          Electron_convValid[400];   //[nElectron]
   Bool_t          Electron_convVeto[400];   //[nElectron]
   Bool_t          Electron_isLowPt[400];   //[nElectron]
   Bool_t          Electron_isPF[400];   //[nElectron]
   Bool_t          Electron_isPFoverlap[400];   //[nElectron]
   UInt_t          nGenPart;
   Float_t         GenPart_eta[2000];   //[nGenPart]
   Float_t         GenPart_mass[2000];   //[nGenPart]
   Float_t         GenPart_phi[2000];   //[nGenPart]
   Float_t         GenPart_pt[2000];   //[nGenPart]
   Float_t         GenPart_vx[2000];   //[nGenPart]
   Float_t         GenPart_vy[2000];   //[nGenPart]
   Float_t         GenPart_vz[2000];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[2000];   //[nGenPart]
   Int_t           GenPart_pdgId[2000];   //[nGenPart]
   Int_t           GenPart_status[2000];   //[nGenPart]
   Int_t           GenPart_statusFlags[2000];   //[nGenPart]
   ...
   Float_t         Muon_matched_dpt[200];   //[nMuon]
   Float_t         Muon_matched_dr[200];   //[nMuon]
   ...
   Float_t         Muon_vx[200];   //[nMuon]
   Float_t         Muon_vy[200];   //[nMuon]
   Float_t         Muon_vz[200];   //[nMuon]
   Int_t           Muon_charge[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu10p5_IP3p5[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu12_IP6[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu7_IP4[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8_IP3[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8_IP5[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8_IP6[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu8p5_IP3p5[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP4[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP5[200];   //[nMuon]
   Int_t           Muon_fired_HLT_Mu9_IP6[200];   //[nMuon]
   Int_t           Muon_isTriggering[200];   //[nMuon]
   Int_t           Muon_looseId[200];   //[nMuon]
   ...
   UInt_t          nProbeTracks;
   Float_t         ProbeTracks_DCASig[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_dxy[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_dxyS[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_dz[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_dzS[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_dzTrg[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_eta[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_mass[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_phi[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_pt[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_vx[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_vy[2000];   //[nProbeTracks]
   Float_t         ProbeTracks_vz[2000];   //[nProbeTracks]
   Int_t           ProbeTracks_charge[2000];   //[nProbeTracks]
   Int_t           ProbeTracks_isLostTrk[2000];   //[nProbeTracks]
   Int_t           ProbeTracks_isPacked[2000];   //[nProbeTracks]
   Int_t           ProbeTracks_nValidHits[2000];   //[nProbeTracks]
   Int_t           ProbeTracks_pdgId[2000];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToEle[2000];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToLooseMuon[2000];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToLowPtEle[2000];   //[nProbeTracks]
   Bool_t          ProbeTracks_isMatchedToMediumMuon[2000];   //[nProbeTracks]
   ...
   Int_t           Electron_genPartIdx[400];   //[nElectron]
   Int_t           Electron_genPartFlav[400];   //[nElectron]
   ...
   TBranch        *b_event;   //!
   TBranch        *b_nBToKEE;   //!
   TBranch        *b_BToKEE_b_3diso03;   //!
   TBranch        *b_BToKEE_b_3diso03_dca;   //!
   TBranch        *b_BToKEE_b_3diso03_dca_tight;   //!
   TBranch        *b_BToKEE_b_3diso04;   //!
   TBranch        *b_BToKEE_b_3diso04_dca;   //!
   TBranch        *b_BToKEE_b_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKEE_k_3diso03;   //!
   TBranch        *b_BToKEE_k_3diso03_dca;   //!
   TBranch        *b_BToKEE_k_3diso03_dca_tight;   //!
   TBranch        *b_BToKEE_k_3diso04;   //!
   TBranch        *b_BToKEE_k_3diso04_dca;   //!
   TBranch        *b_BToKEE_k_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKEE_l1_3diso03;   //!
   TBranch        *b_BToKEE_l1_3diso03_dca;   //!
   TBranch        *b_BToKEE_l1_3diso03_dca_tight;   //!
   TBranch        *b_BToKEE_l1_3diso04;   //!
   TBranch        *b_BToKEE_l1_3diso04_dca;   //!
   TBranch        *b_BToKEE_l1_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKEE_l2_3diso03;   //!
   TBranch        *b_BToKEE_l2_3diso03_dca;   //!
   TBranch        *b_BToKEE_l2_3diso03_dca_tight;   //!
   TBranch        *b_BToKEE_l2_3diso04;   //!
   TBranch        *b_BToKEE_l2_3diso04_dca;   //!
   TBranch        *b_BToKEE_l2_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKEE_l_xy_pv;   //!
   TBranch        *b_BToKEE_l_xy_unc;   //!
   TBranch        *b_BToKEE_l_xy_unc_pv;   //!
   ...
   TBranch        *b_nBToKMuMu;   //!
   TBranch        *b_BToKMuMu_b_3diso03;   //!
   TBranch        *b_BToKMuMu_b_3diso03_dca;   //!
   TBranch        *b_BToKMuMu_b_3diso03_dca_tight;   //!
   TBranch        *b_BToKMuMu_b_3diso04;   //!
   TBranch        *b_BToKMuMu_b_3diso04_dca;   //!
   TBranch        *b_BToKMuMu_b_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKMuMu_k_3diso03;   //!
   TBranch        *b_BToKMuMu_k_3diso03_dca;   //!
   TBranch        *b_BToKMuMu_k_3diso03_dca_tight;   //!
   TBranch        *b_BToKMuMu_k_3diso04;   //!
   TBranch        *b_BToKMuMu_k_3diso04_dca;   //!
   TBranch        *b_BToKMuMu_k_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKMuMu_l1_3diso03;   //!
   TBranch        *b_BToKMuMu_l1_3diso03_dca;   //!
   TBranch        *b_BToKMuMu_l1_3diso03_dca_tight;   //!
   TBranch        *b_BToKMuMu_l1_3diso04;   //!
   TBranch        *b_BToKMuMu_l1_3diso04_dca;   //!
   TBranch        *b_BToKMuMu_l1_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKMuMu_l2_3diso03;   //!
   TBranch        *b_BToKMuMu_l2_3diso03_dca;   //!
   TBranch        *b_BToKMuMu_l2_3diso03_dca_tight;   //!
   TBranch        *b_BToKMuMu_l2_3diso04;   //!
   TBranch        *b_BToKMuMu_l2_3diso04_dca;   //!
   TBranch        *b_BToKMuMu_l2_3diso04_dca_tight;   //!
   ...
   TBranch        *b_BToKMuMu_l_xy_pv;   //!
   TBranch        *b_BToKMuMu_l_xy_unc;   //!
   TBranch        *b_BToKMuMu_l_xy_unc_pv;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_bphys/crovelli/nanoaod_RK/BParkingNANO_2023Apr03/BuToKee_MufilterPt6Eta1p6_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/crab_BuToKee/230403_211851/0000/BParkNANO_mc_2023Apr03_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_bphys/crovelli/nanoaod_RK/BParkingNANO_2023Apr03/BuToKee_MufilterPt6Eta1p6_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/crab_BuToKee/230403_211851/0000/BParkNANO_mc_2023Apr03_1.root");
      }
...
void BParkBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BToKEE_b_3diso03", BToKEE_b_3diso03, &b_BToKEE_b_3diso03);
   fChain->SetBranchAddress("BToKEE_b_3diso03_dca", BToKEE_b_3diso03_dca, &b_BToKEE_b_3diso03_dca);
   fChain->SetBranchAddress("BToKEE_b_3diso03_dca_tight", BToKEE_b_3diso03_dca_tight, &b_BToKEE_b_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKEE_b_3diso04", BToKEE_b_3diso04, &b_BToKEE_b_3diso04);
   fChain->SetBranchAddress("BToKEE_b_3diso04_dca", BToKEE_b_3diso04_dca, &b_BToKEE_b_3diso04_dca);
   fChain->SetBranchAddress("BToKEE_b_3diso04_dca_tight", BToKEE_b_3diso04_dca_tight, &b_BToKEE_b_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKEE_fit_cos3D", BToKEE_fit_cos3D, &b_BToKEE_fit_cos3D);
   ...
   fChain->SetBranchAddress("BToKEE_k_3diso03", BToKEE_k_3diso03, &b_BToKEE_k_3diso03);
   fChain->SetBranchAddress("BToKEE_k_3diso03_dca", BToKEE_k_3diso03_dca, &b_BToKEE_k_3diso03_dca);
   fChain->SetBranchAddress("BToKEE_k_3diso03_dca_tight", BToKEE_k_3diso03_dca_tight, &b_BToKEE_k_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKEE_k_3diso04", BToKEE_k_3diso04, &b_BToKEE_k_3diso04);
   fChain->SetBranchAddress("BToKEE_k_3diso04_dca", BToKEE_k_3diso04_dca, &b_BToKEE_k_3diso04_dca);
   fChain->SetBranchAddress("BToKEE_k_3diso04_dca_tight", BToKEE_k_3diso04_dca_tight, &b_BToKEE_k_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKEE_l1_3diso03", BToKEE_l1_3diso03, &b_BToKEE_l1_3diso03);
   fChain->SetBranchAddress("BToKEE_l1_3diso03_dca", BToKEE_l1_3diso03_dca, &b_BToKEE_l1_3diso03_dca);
   fChain->SetBranchAddress("BToKEE_l1_3diso03_dca_tight", BToKEE_l1_3diso03_dca_tight, &b_BToKEE_l1_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKEE_l1_3diso04", BToKEE_l1_3diso04, &b_BToKEE_l1_3diso04);
   fChain->SetBranchAddress("BToKEE_l1_3diso04_dca", BToKEE_l1_3diso04_dca, &b_BToKEE_l1_3diso04_dca);
   fChain->SetBranchAddress("BToKEE_l1_3diso04_dca_tight", BToKEE_l1_3diso04_dca_tight, &b_BToKEE_l1_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKEE_l2_3diso03", BToKEE_l2_3diso03, &b_BToKEE_l2_3diso03);
   fChain->SetBranchAddress("BToKEE_l2_3diso03_dca", BToKEE_l2_3diso03_dca, &b_BToKEE_l2_3diso03_dca);
   fChain->SetBranchAddress("BToKEE_l2_3diso03_dca_tight", BToKEE_l2_3diso03_dca_tight, &b_BToKEE_l2_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKEE_l2_3diso04", BToKEE_l2_3diso04, &b_BToKEE_l2_3diso04);
   fChain->SetBranchAddress("BToKEE_l2_3diso04_dca", BToKEE_l2_3diso04_dca, &b_BToKEE_l2_3diso04_dca);
   fChain->SetBranchAddress("BToKEE_l2_3diso04_dca_tight", BToKEE_l2_3diso04_dca_tight, &b_BToKEE_l2_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKEE_l_xy_pv", BToKEE_l_xy_pv, &b_BToKEE_l_xy_pv);
   fChain->SetBranchAddress("BToKEE_l_xy_unc", BToKEE_l_xy_unc, &b_BToKEE_l_xy_unc);
   fChain->SetBranchAddress("BToKEE_l_xy_unc_pv", BToKEE_l_xy_unc_pv, &b_BToKEE_l_xy_unc_pv);
   ...
   fChain->SetBranchAddress("BToKMuMu_b_3diso03", BToKMuMu_b_3diso03, &b_BToKMuMu_b_3diso03);
   fChain->SetBranchAddress("BToKMuMu_b_3diso03_dca", BToKMuMu_b_3diso03_dca, &b_BToKMuMu_b_3diso03_dca);
   fChain->SetBranchAddress("BToKMuMu_b_3diso03_dca_tight", BToKMuMu_b_3diso03_dca_tight, &b_BToKMuMu_b_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKMuMu_b_3diso04", BToKMuMu_b_3diso04, &b_BToKMuMu_b_3diso04);
   fChain->SetBranchAddress("BToKMuMu_b_3diso04_dca", BToKMuMu_b_3diso04_dca, &b_BToKMuMu_b_3diso04_dca);
   fChain->SetBranchAddress("BToKMuMu_b_3diso04_dca_tight", BToKMuMu_b_3diso04_dca_tight, &b_BToKMuMu_b_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKMuMu_fit_cos3D", BToKMuMu_fit_cos3D, &b_BToKMuMu_fit_cos3D);
   ...
   fChain->SetBranchAddress("BToKMuMu_k_3diso03", BToKMuMu_k_3diso03, &b_BToKMuMu_k_3diso03);
   fChain->SetBranchAddress("BToKMuMu_k_3diso03_dca", BToKMuMu_k_3diso03_dca, &b_BToKMuMu_k_3diso03_dca);
   fChain->SetBranchAddress("BToKMuMu_k_3diso03_dca_tight", BToKMuMu_k_3diso03_dca_tight, &b_BToKMuMu_k_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKMuMu_k_3diso04", BToKMuMu_k_3diso04, &b_BToKMuMu_k_3diso04);
   fChain->SetBranchAddress("BToKMuMu_k_3diso04_dca", BToKMuMu_k_3diso04_dca, &b_BToKMuMu_k_3diso04_dca);
   fChain->SetBranchAddress("BToKMuMu_k_3diso04_dca_tight", BToKMuMu_k_3diso04_dca_tight, &b_BToKMuMu_k_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKMuMu_l1_3diso03", BToKMuMu_l1_3diso03, &b_BToKMuMu_l1_3diso03);
   fChain->SetBranchAddress("BToKMuMu_l1_3diso03_dca", BToKMuMu_l1_3diso03_dca, &b_BToKMuMu_l1_3diso03_dca);
   fChain->SetBranchAddress("BToKMuMu_l1_3diso03_dca_tight", BToKMuMu_l1_3diso03_dca_tight, &b_BToKMuMu_l1_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKMuMu_l1_3diso04", BToKMuMu_l1_3diso04, &b_BToKMuMu_l1_3diso04);
   fChain->SetBranchAddress("BToKMuMu_l1_3diso04_dca", BToKMuMu_l1_3diso04_dca, &b_BToKMuMu_l1_3diso04_dca);
   fChain->SetBranchAddress("BToKMuMu_l1_3diso04_dca_tight", BToKMuMu_l1_3diso04_dca_tight, &b_BToKMuMu_l1_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKMuMu_l2_3diso03", BToKMuMu_l2_3diso03, &b_BToKMuMu_l2_3diso03);
   fChain->SetBranchAddress("BToKMuMu_l2_3diso03_dca", BToKMuMu_l2_3diso03_dca, &b_BToKMuMu_l2_3diso03_dca);
   fChain->SetBranchAddress("BToKMuMu_l2_3diso03_dca_tight", BToKMuMu_l2_3diso03_dca_tight, &b_BToKMuMu_l2_3diso03_dca_tight);
   fChain->SetBranchAddress("BToKMuMu_l2_3diso04", BToKMuMu_l2_3diso04, &b_BToKMuMu_l2_3diso04);
   fChain->SetBranchAddress("BToKMuMu_l2_3diso04_dca", BToKMuMu_l2_3diso04_dca, &b_BToKMuMu_l2_3diso04_dca);
   fChain->SetBranchAddress("BToKMuMu_l2_3diso04_dca_tight", BToKMuMu_l2_3diso04_dca_tight, &b_BToKMuMu_l2_3diso04_dca_tight);
   ...
   fChain->SetBranchAddress("BToKMuMu_l_xy_pv", BToKMuMu_l_xy_pv, &b_BToKMuMu_l_xy_pv);
   fChain->SetBranchAddress("BToKMuMu_l_xy_unc", BToKMuMu_l_xy_unc, &b_BToKMuMu_l_xy_unc);
   fChain->SetBranchAddress("BToKMuMu_l_xy_unc_pv", BToKMuMu_l_xy_unc_pv, &b_BToKMuMu_l_xy_unc_pv);
